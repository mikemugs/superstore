...
products_layout=dash_table.DataTable(superstore.to_dict('records'), [{"name": "Customer Name", "id": "Customer Name"}, {"name": "Segment", "id": "Segment"}, {"name": "City", "id": "City"}, {"name": "Category", "id": "Category"},{"name": "Profit", "id": "Profit"}],
                                     fixed_rows={'headers': True},style_header={'backgroundColor': 'black','fontWeight': 'bold', "color":'green'}, style_data={"color":"red", 'backgroundColor': 'black'},
    
    style_data_conditional=[
        {
            'if': {
                'filter_query': '{Profit} > 1',
                'column_id': 'Profit'
            },
            'color': 'tomato',
            'fontWeight': 'bold'
...
products_table_ag_grid=dag.AgGrid(rowData=superstore.to_dict('records'),
                                  id="product-table",
                              columnDefs = [{ 'field': 'Product ID'},{ 'field': 'Category',"filter": True },{ 'field': 'Sub-Category',"filter": True},{ 'field': 'Product Name',"filter": True,'headerName': 'Product'},{ 'field': 'Profit',"filter": True }],
